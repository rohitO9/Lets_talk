            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="Review">
                        ...
                        <input type="hidden" id="astrologerId" name="astrologerId" value="<?php echo e($astrologerId); ?>">

                        <div class="text-center">
                            <div class="form-group">
                                <label for="rating">Rating:</label>
                                <div class="star-rating"
                                    data-rating="<?php echo e(isset($getUserHistoryReview['recordList'][0]['rating']) ? $getUserHistoryReview['recordList'][0]['rating'] : ''); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="review" name="review" rows="3" placeholder="Enter your review"><?php echo e(isset($getUserHistoryReview['recordList'][0]['review']) ? $getUserHistoryReview['recordList'][0]['review'] : ''); ?></textarea>
                            </div>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        $(document).ready(function() {
            var existingRating =
                "<?php echo e(isset($getUserHistoryReview['recordList'][0]['rating']) ? $getUserHistoryReview['recordList'][0]['rating'] : ''); ?>";
        ...
        function renderMessage(message, receiverId) {
            ...
            <div class="chat-message chat-message-center d-flex m-3" style="justify-content: center;">
                ...
                messageElement.innerHTML = `
        <div>
            <img src="/<?php echo e($getAstrologer['recordList'][0]['profileImage']); ?>" class="rounded-circle mr-1" alt="Sender" width="40" height="40">
        ...
        <div class="flex-shrink-1 bg-light rounded py-2 px-3 ml-3 mb-2">
            ...
            ${message.attachementPath ? renderAttachment(message.attachementPath) : `<p>${message.message}</p>`}
                ...
                messageElement.innerHTML = `
            <div>
                <img src="/<?php echo e(authcheck()['profile']); ?>" class="rounded-circle mr-1" alt="You" width="40" height="40">
                <div class="text-muted small text-nowrap mt-2">${formattedTime}</div>
            </div>
    ...
    <script>
        $('#reviewbtn').click(function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('api.addUserReview', ['token' => $token])); ?>",
                type: 'POST',
                data: formData,
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/resources/views/frontend/pages/chat-history.blade.php ENDPATH**/ ?>