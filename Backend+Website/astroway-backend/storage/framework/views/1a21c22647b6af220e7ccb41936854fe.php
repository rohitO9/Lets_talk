...
<?php $__env->startSection('subcontent'); ?>
    ...
    <form class="addbtn mt-10" action="<?php echo e(route('dailyHoroscopeInsight')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div style="display: inline-block" class="input mt-2 sm:mt-0">
            <select class="form-control w-full" id="filterSign" name="filterSign" value="filterSign">
                <?php $__currentLoopData = $signs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sign): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option id="signId" <?php if($sign['id'] == $selectedId): ?> selected <?php endif; ?> value="<?php echo e($sign['id']); ?>">
                        <?php echo e($sign['name']); ?></option>
    ...
    <div class="col-span-12 lg:col-span-7 2xl:col-span-8">
        <div class="grid grid-cols-12 gap-6 mt-5 list-table">
            <?php $__currentLoopData = $dailyHoroscopeInsight; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $insight): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="box">
                        <div class="p-5">
                            <div
                                ...
                                <img alt="Horoscope image" class="rounded-t-md" src="/<?php echo e($insight->coverImage); ?>">
                                    ...
                                    <div class="dropdown ml-3">
                                        ...
                                        <div class="dropdown-menu w-40">
                                            <ul class="dropdown-content">
                                                <li>
                                                    <a id="editbtn"
                                                        onclick='editbtn(<?php echo e($insight->id); ?>,"<?php echo e($insight->name); ?>","<?php echo e($insight->coverImage); ?>","<?php echo e($insight->title); ?>",<?php echo e(json_encode($insight->description)); ?>,<?php echo e($insight->horoscopeSignId); ?>,"<?php echo e($insight->horoscopeDate); ?>","<?php echo e($insight->link); ?>")'
                                                    ...
                                                    <a id="deletebtn" onclick="deletebtn(<?php echo e($insight->id); ?>)"
                                ...
                                <div class="absolute bottom-0 text-white px-5 pb-6 z-10">
                                    <a href="" class="block font-medium text-base"><?php echo e($insight->name); ?></a>
                                    <span
                                        class="text-white/90 text-xs mt-3"><?php echo e(date('d-m-Y', strtotime($insight->horoscopeDate))); ?></span>
                                </div>
                            </div>
                            <div class="text-slate-600 dark:text-slate-500 mt-5">
                                <h2 class="font-medium text-xl"><?php echo e($insight->title); ?></h2>
                                <div class="flex items-center mt-2">
                                    <i data-lucide="layers" class="w-4 h-4 mr-2"></i> Horoscope Sign:
                                    <?php echo e($insight->signName); ?>
                                ...
                                <?php if($insight->link): ?>
                                    <a href=" <?php echo e($insight->link); ?>"class="flex mt-2 active" target="_blanck"
                                        style="color: blue">
                                        <i data-lucide="link" class="w-4 h-4 mr-2"></i> link:
                                        <?php echo e($insight->link); ?>
    ...
    <div id="add-dailyHoroscope" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <form data-single="true" action="<?php echo e(route('addDailyHoroscopeInsight')); ?>" method="POST"
                                ...
                                <div class="sm:grid grid-cols gap-2">
                                    <div class="input mt-2 sm:mt-0">
                                        ...
                                        <select class="form-control" id="horoscopeSignId" name="horoscopeSignId"
                                            ...
                                            <?php $__currentLoopData = $signs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sign): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option id="productCategoryId" value=<?php echo e($sign['id']); ?>>
                                                    <?php echo e($sign['name']); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
    ...
    <div id="edit-dailyHoroscope" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <form data-single="true" action="<?php echo e(route('editDailyHoroscopeInsight')); ?>" method="POST"
                    enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body p-0">
                    ...
                    <form action="<?php echo e(route('deleteHoroscopeInsight')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/astroway.diploy.in/httpdocs/resources/views/pages/daily-horoscope-insight.blade.php ENDPATH**/ ?>