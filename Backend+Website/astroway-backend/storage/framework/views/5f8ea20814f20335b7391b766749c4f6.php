                                                        ...
                                                        <div class="row mb-2">
                                                            <div class="col-10">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col pl-1">
                                                                        <a href="<?php echo e(route('front.astrologers.kundaliReport', ['kundali_id' => $getkundali['id']])); ?>" class="colorblack">
                                                                            <p
...
<?php echo $__env->make('frontend.astrologers.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/resources/views/frontend/astrologers/pages/kundali.blade.php ENDPATH**/ ?>