    ...
    <script>
        ...
        jQuery(function() {
            jQuery('#add-form').submit(function(e) {
                ...
                jQuery.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('addDailyHoroscope')); ?>",
                    data: data,
                    dataType: 'JSON',
                    processData: false,
                    contentType: false,
                    success: function(data) {
                        if (jQuery.isEmptyObject(data.error)) {
                            ...
                            jQuery.ajax({
                                type: 'POST',
                                url: "<?php echo e(route('dailyHoroscope')); ?>",
                                data: filterData,
                                dataType: 'JSON',
                                processData: false,
                                contentType: false,
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/astroway.diploy.in/httpdocs/resources/views/pages/add-daily-horoscope.blade.php ENDPATH**/ ?>