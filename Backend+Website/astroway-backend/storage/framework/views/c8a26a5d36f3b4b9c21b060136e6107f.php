        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body p-0">
                    ...
                    <form action="<?php echo e(route('deleteUser', $commi->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/astroway.diploy.in/httpdocs/resources/views/pages/commission-list.blade.php ENDPATH**/ ?>